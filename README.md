...
[![Build Status](https://travis-ci.org/fastily/wp-toolbox.svg?branch=master)](https://travis-ci.org/fastily/wp-toolbox)
...
Miscellaneous shared functionality for my Wikipedia bots and tools.  Posted here to public benefit.